...
// const dbClient = new MongoClient(buildMongoURLFromConfig(mongodb_config));
...
//     before(async () => await dbClient.connect());
...
//         addGuildToDatabase(null)
//             .then(async () => {

//                 const cursor = await dbClient.db(DATABASE).collection(GUILDS_COLLECTION).findOne({
//                     guildId: 'myguild'
//                 });
...
//         dbClient.db(DATABASE).collection(GUILDS_COLLECTION).insertOne({
//             guildId: 'myguild'
//         })
//             .then(cursor => {
...
//     afterEach(async () => {
//         await dbClient.db(DATABASE).collection(GUILDS_COLLECTION).drop();
//     })
